...
typedef std::shared_ptr<Pseq> Pseq_ptr;
typedef std::shared_ptr<Mseq> Mseq_ptr;
...
typedef std::shared_ptr<Oorr>   Oorr_ptr;
...
public:
    Name     name;
    Expn_ptr expn;
    Ntro(Name x, Expn_ptr e, Locn l) :
        Stmt {l}, name {x},expn {e} { }
...
//
//Pseq = plus equal nodes
//

class Pseq : public Stmt {
public:
    Name name;
    Expn_ptr expn;
    Pseq(Name x, Expn_ptr e, Locn l) : Stmt {l}, name {x}, expn {e} { }
    virtual ~Pseq(void) = default;
    virtual std::optional<Valu> exec(const Defs& defs, Ctxt& ctxt) const;
    virtual void output(std::ostream& os, std::string indent) const;
    virtual void dump(int level = 0) const;
};
//Minus equal
class Mseq : public Stmt {
public:
    Name name;
    Expn_ptr expn;
    Mseq(Name x, Expn_ptr e, Locn l) : Stmt {l}, name {x}, expn {e} { }
    virtual ~Mseq(void) = default;
    virtual std::optional<Valu> exec(const Defs& defs, Ctxt& ctxt) const;
    virtual void output(std::ostream& os, std::string indent) const;
    virtual void dump(int level = 0) const;
};
...
public:
    ...
    Blck_ptr then_blck;
    //Blck_ptr else_blck;
    IfEl(Expn_ptr cd, Blck_ptr tb, Locn l) :
        Stmt {l}, cndn {cd}, then_blck {tb} { }
...
class Oorr : public Expn {
public:
    Expn_ptr left;
    Expn_ptr rght;
    Oorr(Expn_ptr lf, Expn_ptr rg, Locn lo)
        : Expn {lo}, left {lf}, rght {rg} { }
    virtual ~Oorr(void) = default;
    virtual Valu eval(const Defs& defs, const Ctxt& ctxt) const;
    virtual void output(std::ostream& os) const;
    virtual void dump(int level = 0) const;
};
